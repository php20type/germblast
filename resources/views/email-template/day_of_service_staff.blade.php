...
<h2 style="margin-top: 0;">Service Order Scheduled Today — GermBlast</h2>
...
<p style="font-size: 16px; line-height: 24px;">
    This is a friendly reminder that you have a service order scheduled for today!
    Below are the schedule details:
</p>
