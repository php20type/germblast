...
@section('title', 'Residential Report')
                ...
                <div class="main-content">
                    ...
                    <div class="heading-area-sec mb-3">
                        <div class="left-part-sec">
                            <h3 class="mb-1">Residential Report <span style="font-size: 24px;">🏠</span></h3>
                    ...
                    <div class="px-4 pb-4">
                        <div class="table-responsive">
                            <table id="residentialTable" class="table table-hover w-100 equipment-report-table">
                                <thead>
                                    <tr>
                                        <th class="bg-light fw-bold text-dark border-end" style="border-color: #ddd !important; font-size: 14px;">Client</th>
                                        <th class="bg-light fw-bold text-dark border-end" style="border-color: #ddd !important; font-size: 14px;">City</th>
                                        <th class="bg-light fw-bold text-dark border-end" style="border-color: #ddd !important; font-size: 14px;">Special?</th>
                                        <th class="bg-light fw-bold text-dark border-end" style="border-color: #ddd !important; font-size: 14px;">Date</th>
                                        <th class="bg-light fw-bold text-dark" style="font-size: 14px;">Price</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
