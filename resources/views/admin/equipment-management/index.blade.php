...
@section('content')
                                        ...
                                        <div class="section-card">
                                            @foreach($dirtyTypes as $type)
                                                <div class="row align-items-center border-bottom py-3">
                                                    ...
                                                    <div class="col-3">
                                                        Status:
                                                        <span class="text-primary" style="cursor: pointer;" data-id="{{ $type->id }}"
    ...
    {{-- ============================================================ --}}
    <div class="modal fade" id="universalStatusModal" tabindex="-1" aria-labelledby="universalStatusModalLabel" aria-hidden="true">
    ...
    {{-- ============================================================ --}}
    <div class="modal fade" id="equipmentHistoryModal" tabindex="-1" aria-labelledby="equipmentHistoryModalLabel" aria-hidden="true">
