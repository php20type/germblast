                        ...
                        <div class="main-content">
                            ...
                            <div class="heading-area-sec">
                                <div class="left-part-sec">
                                    <h3 class="mb-1">Marketing contacts <i class="fas fa-thumbtack pinned-icon"></i></h3>
                                    <p class="text-muted mb-0">Contacts (or the individuals) you do business with</p>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center position-relative">
                                            ...
                                            <span class="company-count">13,773 people found</span>
                                            <a href="#" class="remove-link">Remove filters</a>
                                        </div>
                                    </div>
                                    <div class="col-md-6 ">
