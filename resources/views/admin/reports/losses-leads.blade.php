                    ...
                    <div class="sales-dashboard">
                        ...
                        <div class="heading-area-sec mb-3">
                            <div class="left-part-sec">
                                <h3 class="mb-1 text-uppercase">LOST LEADS <span style="font-size: 24px;">📌</span></h3>
                        ...
                        <div class="filter-section py-3 px-4 mx-4 my-3 rounded-3 border bg-white"
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                ...
                                <div class="d-flex align-items-center gap-1 bg-light p-1 rounded-3 border"
                                    style="border-color: #e5e7eb !important;">
                                    <a href="{{ route('admin.reports.losses.leads', ['period' => request('period', 'year'), 'offset' => $offset - 1]) }}"
                                    ...
                                    <a href="{{ route('admin.reports.losses.leads', ['period' => request('period', 'year'), 'offset' => 0]) }}"
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="d-flex gap-3 text-muted fw-bold" style="font-size: 13px;">
                                            ...
                                            <a href="{{ route('admin.reports.losses.leads', ['period' => 'week']) }}" class="text-decoration-none {{ request('period') === 'week' ? 'text-primary border-bottom border-primary border-2 pb-1' : 'text-muted pb-1 cursor-pointer' }}">Week</a>
                                            ...
                                            <a href="{{ route('admin.reports.losses.leads', ['period' => 'year']) }}" class="text-decoration-none {{ request('period', 'year') === 'year' ? 'text-primary border-bottom border-primary border-2 pb-1' : 'text-muted pb-1 cursor-pointer' }}">Year</a>
                                        </div>
                                    </div>
                                </div>
