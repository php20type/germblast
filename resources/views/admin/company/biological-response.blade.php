        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <form action="{{ route('admin.companies.biological.response.store', $company->id) }}" method="POST"
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="more_than_2_rooms" class="form-control">
                                                            <option value="">Select One</option>
                                                            <option value="0">No</option>
                                                            <option value="1">Yes</option>
                                                        </select>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="high_consequence_infectious_disease"
                                                            class="form-control">
                                                            <option value="">Select One</option>
                                                            <option value="0">No</option>
                                                            <option value="1">Yes</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            function toggleCasualtySections(value) {
                ...
                // Hide & disable all conditional sections
            ...
            $('#biological-response-intake-form').on('submit', function(e) {
                ...
                let form = $(this);
                const casualtyType = $('[name="casualties_or_illnesses"]').val();
                ...
                if (casualtyType === 'Death') {

                    if (!$('[name="cause_of_death"]').val()) {
                        alert('Cause of death is required');
                        return;
                    }

                    if (!$('[name="number_of_deaths"]').val()) {
                        alert('Number of deaths is required');
                        return;
                    }

                    if (!$('[name="body_unattended"]').val()) {
                        alert('Please select body unattended');
                        return;
                    }

                    if (!$('[name="more_than_2_rooms"]').val()) {
                        alert('Please select more than 2 rooms');
                        return;
                    }

                    if (!$('[name="high_consequence_infectious_disease"]').val()) {
                        alert('Please select infectious disease option');
                        return;
                    }
                }
                ...
                /* ======================
                   ILLNESS VALIDATION
                ====================== */
                if (casualtyType === 'Illness') {

                    if (!$('[name="person_travelled_outside"]').val()) {
                        alert('Please select travel option');
                        return;
                    }

                    if (!$('[name="diagnosis"]').val()) {
                        alert('Please select diagnosis');
                        return;
                    }

                    if (!$('[name="number_of_diagnosis"]').val()) {
                        alert('Number of diagnosis is required');
                        return;
                    }
                ...
                /* ======================
                   POLICE (COMMON)
                ====================== */
                if (casualtyType === 'Death' || casualtyType === 'Illness') {

                    if (!$('[name="police_cleanup"]').val()) {
                        alert('Please select police cleanup');
                        return;
                    }

                    if (!$('[name="police_number"]').val()) {
                        alert('Police number is required');
                        return;
                    }

                    if (!$('[name="overdose"]').val()) {
                        alert('Please select overdose');
                        return;
                    }

                    if (!$('[name="gunshot"]').val()) {
                        alert('Please select gunshot');
                        return;
                    }
                }
