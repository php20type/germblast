                        ...
                        <div class="sales-dashboard">
                            ...
                            <div class="dashboard-header section-card d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted">Edit Indoor Air Quality Survey</p>
                                </div>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="building_description" class="form-control" rows="3">{{ old('building_description', $survey->building_description) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="reported_issues" class="form-control" rows="3">{{ old('reported_issues', $survey->reported_issues) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="odor_desc" class="form-control" rows="3">{{ old('odor_desc', $survey->odor_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="dirty_unsanitary_desc" class="form-control" rows="3">{{ old('dirty_unsanitary_desc', $survey->dirty_unsanitary_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="visible_microbial_desc" class="form-control" rows="3">{{ old('visible_microbial_desc', $survey->visible_microbial_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="material_staining_desc" class="form-control" rows="3">{{ old('material_staining_desc', $survey->material_staining_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="adequate_ventilation_desc" class="form-control" rows="3">{{ old('adequate_ventilation_desc', $survey->adequate_ventilation_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="hvac_duct_blocked_desc" class="form-control" rows="3">{{ old('hvac_duct_blocked_desc', $survey->hvac_duct_blocked_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="filter_adequate_desc" class="form-control" rows="3">{{ old('filter_adequate_desc', $survey->filter_adequate_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="filter_adequate_and_healthy_describe" class="form-control" rows="3">{{ old('filter_adequate_and_healthy_describe', $survey->filter_adequate_and_healthy_describe) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="chemical_storage_desc" class="form-control" rows="3">{{ old('chemical_storage_desc', $survey->chemical_storage_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="temp_within_ashre_desc" class="form-control" rows="3">{{ old('temp_within_ashre_desc', $survey->temp_within_ashre_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="overcrowding_desc" class="form-control" rows="3">{{ old('overcrowding_desc', $survey->overcrowding_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="poor_iaq_activities_desc" class="form-control" rows="3">{{ old('poor_iaq_activities_desc', $survey->poor_iaq_activities_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="water_intrusion_desc" class="form-control" rows="3">{{ old('water_intrusion_desc', $survey->water_intrusion_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="carpet_present_desc" class="form-control" rows="3">{{ old('carpet_present_desc', $survey->carpet_present_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="pest_management_desc" class="form-control" rows="3">{{ old('pest_management_desc', $survey->pest_management_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="dirty_air_diffusers_desc" class="form-control" rows="3">{{ old('dirty_air_diffusers_desc', $survey->dirty_air_diffusers_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Describe</th>
                                                    <td>
                                                        <textarea name="mhvac_equipment_desc" class="form-control" rows="3">{{ old('mhvac_equipment_desc', $survey->mhvac_equipment_desc) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Result</th>
                                                    <td>
                                                        <textarea name="result" id="result" class="form-control">{{ old('result', $survey->result) }}
                                                        </textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
