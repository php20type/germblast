                                ...
                                <div class="col-md-12">
                                    <div class="section-card">
                                        ...
                                        <div class="section-header">
                                            <h3 class="section-title">Create Pricing Proposal</h3>
                                        </div>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="pricing_total" class="form-control"
                                                            value="">
                                                        {{-- pricing total = partial cost + awareness +  education + technology + responses + logistics expense --}
                                                    </td>
                                                </tr>
                                                ...
                                                <!-- PROPOSAL SETTINGS -->
                                                <tr>
                                                    <th colspan="2" class="bg-light fw-bold">Proposal Settings</th>
                                                </tr>

                                                <tr>
                                                    <th>Proposal Name<span class="text-danger">*</span></th>
                                                ...
                                                <!-- CONTRACT DETAILS -->
                                                <tr>
                                                    <th colspan="2" class="bg-light fw-bold">Contract Details</th>
                                                </tr>

                                                <tr>
                                                    <th>Services per Year<span class="text-danger">*</span></th>
