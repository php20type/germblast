        ...
        <div class="row">
            <div class="col-md-12 p-0">
                ...
                <form action="#" method="POST" id="edit-pricing-form">
                    ...
                    <!-- Required IDs -->
                    <input type="hidden" name="pricing_proposal_id" value="{{ $pricingProposal->id }}">
                    <input type="hidden" name="survey_proposal_id" value="{{ $pricingProposal->survey_proposal_id }}">
                    ...
                    <div class="sales-dashboard">
                        <div class="dashboard-header section-card d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button type="button" id="updatePricingBtn" class="btn btn-primary">
                                ...
                                <div class="section-card">
                                    ...
                                    <table class="table table-bordered align-middle">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th colspan="2" class="bg-light fw-bold">Total Labor Cost for All Areas Included</th>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="partial_cost_service" class="form-control"
                                                           value="{{ $pricingProposal->partial_cost_service ?? '' }}">
                                                </td>
                                            </tr>

                                            <tr>
                                                <th colspan="2" class="bg-light fw-bold">Estimated Costs Already Included</th>
                                            </tr>
                                            ...
                                            <tr>
                                                <th colspan="2" class="bg-light fw-bold">Estimated Costs Not Included</th>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control" name="proposal_order"
                                                           value="{{ $pricingProposal->proposal_order ?? '' }}"></td>
                                            </tr>

                                            <tr>
                                                <th>Override Pricing *</th>
                                                <td><input type="text" class="form-control" name="override_pricing"
                                                           value="{{ $pricingProposal->override_pricing ?? '' }}"></td>
                                            </tr>

                                            <tr>
                                                <th>Discounts (%) *</th>
                                                <td><input type="number" class="form-control" name="discounts"
                                                           value="{{ $pricingProposal->discounts ?? '' }}"></td>
                                            </tr>

                                            <tr>
                                                <th>Description *</th>
                                                <td><textarea class="form-control" name="descriptions" rows="2">{{ $pricingProposal->descriptions ?? '' }}</textarea></td>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control" name="services_per_year"
                                                           value="{{ $pricingProposal->services_per_year ?? '' }}"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="prepayment_discount" class="form-control">
                                                        ...
                                                        <option value="1" {{ $pricingProposal->prepayment_discount == 1 ? 'selected' : '' }}>Yes</option>
                                                        <option value="0" {{ $pricingProposal->prepayment_discount == 0 ? 'selected' : '' }}>No</option>
                                                    </select>
                                                </td>
                                            </tr>
...
<script>
    ...
    $("#edit-pricing-form").validate({
        ...
        rules: {
            ...
            proposal_order: { required: true, number: true },
            override_pricing: { required: true },
            discounts: { required: true, number: true },
            descriptions: { required: true },
            services_per_year: { required: true, number: true },
            contract_terms: { required: true, number: true },
            prepayment_discount: { required: true },
        },
        errorElement: 'span',
    ...
    $('#edit-pricing-form').on('submit', function (e) {
        ...
        $.ajax({
            url: "{{ route('admin.pricing-proposal.update', $pricingProposal->id) }}",
            method: "POST",
            data: $(this).serialize(),
            ...
            success: function (res) {
                Swal.fire({
                    icon: "success",
                    title: "Updated!",
                    text: res.message || "Pricing Proposal Updated Successfully!",
                    timer: 2000,
