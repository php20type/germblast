                        ...
                        <div class="main-content">
                            ...
                            <div class="heading-area-sec mb-3 px-4 pt-4 d-flex justify-content-between align-items-center">
                                <div class="left-part-sec">
                                    <h3 class="mb-1">
                                        Edit Pricing Proposal <span style="font-size: 24px;">💰</span>
                                    </h3>
                                    <p class="text-muted mb-0">
                                        Modify the existing pricing proposal
                                    </p>
                                </div>
                                <div class="right-part d-flex align-items-center gap-2">
                                    <a class="btn btn-outline-dark" href="{{ route('admin.lead.survey.proposal', $pricingProposal->surveyProposal->lead_id) }}">
