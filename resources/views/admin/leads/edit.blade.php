...
@section('content')
    ...
    <div class="company-details-section">
                                                            ...
                                                            <div class="row g-2 align-items-center">
                                                                ...
                                                                <div class="col-md-8 col-12">
                                                                    <input type="datetime-local" name="schedule_meeting_date"
                                                                        id="schedule_meeting_date" class="form-control" required>
                                                                </div>

                                                                <div class="col-md-4 col-12">
                                                                    <button class="btn btn-success w-100" onclick="scheduleMeeting()">
                                                                        Schedule
                                                                    </button>
                                                                </div>
                                                ...
                                                <div class="col-md-6 d-flex justify-content-end">
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button class="btn btn-sm btn-outline-primary toggleEditTask"
                                                            ...
                                                            data-due="{{ $task->due_time }}" data-user="{{ $task->assignee_id }}"
                                ...
                                <form id="addTaskAjaxForm" action="{{ route('admin.lead.tasks.store', $leads->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-2">
                                                <textarea rows="3"
                                                    placeholder="Include any description you need to help complete this task…"
                                                ...
                                                <div class="col-md-4 d-flex justify-content-end">
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button class="btn btn-sm btn-outline-success log-activity-btn"
                                                            title="Mark as Completed" data-id="{{ $scheduled_activity->id }}">
                                                            Log Activity
                                                        </button>
                        ...
                        <div class="section-card">
                            ...
                            @can('lead.detail.edit')
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active activity-form" id="write-activity-content"
                                        ...
                                        <form action="{{ route('admin.login.activity') }}" method="post" data-owner-type="Lead"
                                            data-owner-id="{{ $leads->id }}" data-status="Logged" id="loginActivity">
                                            @csrf
                                    ...
                                    <div class="tab-pane fade activity-form" id="write-note-content" role="tabpanel"
                                        ...
                                        <form action="{{ route('admin.add.note') }}" method="POST" data-owner-type="Lead"
                                            ...
                                            <input type="hidden" name="mentioned_company_ids" id="note_mentioned_company_ids"
                                                value="">
                            ...
                            <div class="filter-section">
                                <div class="row g-2">
                                    ...
                                    <div class="col-auto">
                                        <select class="form-select dropdown-orange select2" id="filter-user" name="user_id"
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    <div class="timeline-body">
                                                        <div class="row align-items-center">
                                                            ...
                                                            @can('lead.detail.edit')
                                                                <div class="col-4 text-end">
                                                                    <button class="btn btn-sm btn-outline-primary me-1 add-comment-btn"
                                                                    ...
                                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                                        ...
                                                                        @can('lead.detail.edit')
                                                                            <span class="btn btn-sm delete-comment-btn"
                                                                                data-id="{{ $comment->id }}" data-type="Activity">
                                                                                <i class="fas fa-times"></i>
                                                                            </span>
                                                                        @endcan
                                                                    </div>
                                                        ...
                                                        @can('lead.detail.edit')
                                                            <div class="mt-3 d-none add-comment" data-id="{{ $item->id }}"
                                                                data-type="Activity">
                                                                <textarea id="activity-comment-textarea" name="comment_text"
                                                                    class="form-textarea" placeholder="Write a comment…"
                                                                    data-tribute="true" style="width:100%"></textarea>

                                                                <button class="mt-3 btn btn-sm btn-outline-success add-comment-submit"
                                                                    title="">
                                                                    Add Comment
                                                                </button>
                                                                <button class="mt-3 btn btn-sm btn-outline-danger comment-cancel"
                                                                    title="Close">
                                                                    Close
                                                                </button>
                                                            </div>
                                                    ...
                                                    <div class="timeline-body">
                                                        <div class="row align-items-center">
                                                            ...
                                                            @can('lead.detail.edit')
                                                                <div class="col-4 text-end">
                                                                    <button class="btn btn-sm btn-outline-primary me-1 add-comment-btn"
                                                                        title="Add Comment" data-type="Note" data-id="{{ $item->id }}">
                                                                        <i class="fas fa-comment"></i>
                                                                    </button>
                                                                    <button class="btn btn-sm btn-outline-danger delete-note-btn"
                                                                        title="Delete Note" data-type="Note" data-id="{{ $item->id }}">
                                                                        <i class="fas fa-times"></i>
                                                                    </button>
                                                                </div>
                                                            @endcan
                                                        ...
                                                        @can('lead.detail.edit')
                                                            <div class="mt-3 d-none add-comment" data-id="{{ $item->id }}"
                                                                data-type="Note">
                                                                <textarea id="note-comment-textarea" name="comment_text"
                                                                    class="form-textarea" placeholder="Write a comment…"
                                                                    data-tribute="true" style="width:100%"></textarea>
                                                                <button class="mt-3 btn btn-sm btn-outline-success add-comment-submit"
                                                                    title="">
                    ...
                    <div class="sidebar">
                        ...
                        <div id="leads-details-container" data-lead-id="{{ $leads->id }}">
                                    ...
                                    <div class="form-group mb-3 d-none" id="lostOutcomeWrapper">
                                        ...
                                        <select class="form-select" id="lostOutcomeSelect">
                                            ...
                                            @foreach ($lost_outcomes as $outcome)
                                                <option value="{{ $outcome->id }}" {{ $leads->outcome_id == $outcome->id && $leads->lead_status == 'lost' ? 'selected' : '' }}>
                                                    {{ $outcome->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-3 d-none" id="cancelledOutcomeWrapper">
                                        ...
                                        <select class="form-select" id="cancelledOutcomeSelect">
                                            ...
                                            @foreach ($cancelled_outcomes as $outcome)
                                                <option value="{{ $outcome->id }}" {{ $leads->outcome_id == $outcome->id && $leads->lead_status == 'cancelled' ? 'selected' : '' }}>
                                                    {{ $outcome->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-check">
                                                    <input class="form-check-input lead-flag" name="lead_flag" type="checkbox"
                                                        value="is_watching" id="checkbox1" data-lead-id="{{ $leads->id }}" @if ($leads->is_watching) checked @endif>
                                            ...
                                            <div class="col-6">
                                                <div class="form-check">
                                                    <input class="form-check-input lead-flag" name="lead_flag" type="checkbox"
                                                        value="is_hot" id="checkbox2" data-lead-id="{{ $leads->id }}" @if ($leads->is_hot) checked @endif>
                                ...
                                <div class="form-group mb-3">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input lead-flag" name="lead_flag" type="checkbox"
                                                    value="is_watching" id="checkbox1" data-lead-id="{{ $leads->id }}" @if ($leads->is_watching) checked @endif disabled>
                                                <label class="form-check-label" for="checkbox1"><b>Watching</b></label>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input lead-flag" name="lead_flag" type="checkbox"
                                                    value="is_hot" id="checkbox2" data-lead-id="{{ $leads->id }}" @if ($leads->is_hot) checked @endif disabled>
                                                <label class="form-check-label" for="checkbox2"><b>Hot</b></label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="company-list d-block mb-3"
                                            ...
                                            <div class="row align-items-start w-100 m-0 g-2">
                                                <div class="col-auto p-0">
                                                    <div class="company-icon" style="width: 50px; height: 50px;">
                                                        <img src="{{ $leads->company->photo ? asset('storage/' . $leads->company->photo) : asset('img/home/companyimages1.png') }}"
                                                            alt="Company Logo" class="img-fluid rounded-circle" style="object-fit: cover; width: 100%; height: 100%;">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-auto p-0">
                                                        <div class="company-icon" style="width: 50px; height: 50px;">
                                                            <img src="{{ $person->photo ? asset('storage/' . $person->photo) : asset('img/home/profile-image.png') }}"
                                                                alt="People Logo" class="img-fluid rounded-circle" style="object-fit: cover; width: 100%; height: 100%;">
                                                        </div>
                                                    </div>
                                                    <div class="col p-0 ps-3">
                                                        <div class="company-name">
                            ...
                            <div class="sidebar-section">
                                            ...
                                            <div class="company-list d-flex justify-content-between align-items-center mb-3"
                                                ...
                                                @can('lead.detail.edit')
                                                    <div id="delete-competitor">
                                                        <button class="btn btn-sm btn-outline-secondary delete-item"
                                                            data-lead="{{ $leads->id }}" data-id="{{ $leadCompetitor->id }}"
                                ...
                                <div class="form-group mb-3" id="source-container">
                                    ...
                                    @can('lead.detail.edit')
                                        <div id="add-source" class="mb-3 d-none">
                                            <select class="form-select update-field-select" data-type="source" id="urlInput">
                                ...
                                {{-- Quotes --}}
                                <div class="form-group mb-3 d-none" id="quote-container">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h6 class="text-uppercase">
                                            Quotes
                                        </h6>
        ...
        {{-- Activities modal --}}
        <div class="modal fade" id="schedule-activity" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <!-- Hidden field to store processed note content -->
                                        <input type="hidden" name="schedule_note_value" id="schedule_note_value" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <textarea rows="5" placeholder="Add an agenda to share with your attendees"
                                        class="form-control" name="agenda"></textarea>
                                </div>
        ...
        <div class="modal fade" id="add-forecasting" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body ps-0">
                        ...
                        <form id="add_forecasting" class="company-form" action="{{ route('admin.lead.forecasting.store') }}"
                            method="POST" data-owner-id="{{ $leads->id }}">
                            @csrf
                            ...
                            <div class="row mx-0">
                                <div class="col-lg-12 mb-3">
                                    <label class="form-label">Confidence Level <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="confidence"
                                        value="{{ $leads->confidence ?? '' }}" placeholder="Enter confidence level">
                                </div>

                                <div class="col-lg-12 mb-3">
                                    <label class="form-label">Number of Services <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-12 mb-3">
                                    <label class="form-label">First Service Date <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="service_date" name="expected_first_date"
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    $(document).on('click', '.stage-item', function () {
                        ...
                        // Special warning for Proposal Approval stage (stage 3)
                            ...
                            if (newStageId == 3) {
                                swalTitle = 'Send for Proposal Approval?';
                                swalHtml = `
                                    <div style="text-align: left; padding: 10px;">
                                        ...
                                        <ul style="text-align: left; padding-left: 20px; margin-bottom: 10px;">
                                            <li style="margin-bottom: 8px;">The survey proposal will be sent to management for review</li>
                                            <li style="margin-bottom: 8px;">Status will be changed to <strong>"Pending Review"</strong></li>
                                            <li style="margin-bottom: 8px;"><strong style="color: #d33;">No changes will be allowed</strong> until management takes action</li>
                                            <li style="margin-bottom: 8px;">This action <strong>cannot be undone</strong> without management approval</li>
                                        </ul>
                            ...
                            Swal.fire({
                                ...
                                icon: 'warning',
                                showCancelButton: true,
                                confirmButtonColor: newStageId == 3 ? '#d33' : '#3085d6',
                                cancelButtonColor: '#6c757d',
                                confirmButtonText: newStageId == 3 ? 'Yes, send for approval' : 'Yes, change it',
                            ...
                            toggleTaskBtn.addEventListener('click', function(e) {
                                ...
                                if (formTaskDiv.style.display === "none" || formTaskDiv.style.display === "") {
                                    ...
                                    if (form) {
                                        ...
                                        form.setAttribute(
                                            'action',
                                            "{{ route('admin.lead.tasks.store', $leads->id) }}"
                                        );
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        const uploadForm = document.getElementById("leadFileUploadForm");
                        ...
                        const leadId = uploadForm.dataset.leadId;
