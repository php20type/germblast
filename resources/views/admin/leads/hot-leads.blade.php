                        ...
                        <div class="main-content">
                            ...
                            <div class="heading-area-sec">
                                <div class="left-part-sec">
                                    <h3 class="mb-1">HOT LEADS <span style="font-size: 24px;">📌</span></h3>
                                    <p class="text-muted mb-0">Hot business deals</p>
                                </div>
                            @can('lead.create')
                            ...
                            <div class="filter-value">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="filter-card">
                                            <h5 id="avg-time-open-value">Avg time open:<span>{{ $avgTimeOpen ?? 0 }} Days</span></h5>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="filter-card">
    ...
    <script>
        ...
        $(document).ready(function() {
            function fetchLeads() {
                ...
                $.ajax({
                    url: "{{ route('admin.lead.hot_leads') }}",
                    method: "GET",
                    data: {
                        search: search,
                        status: status,
