                    ...
                    <div class="sales-dashboard">
                        ...
                        <div class="heading-area-sec border-bottom-0 pb-0">
                            <div class="left-part-sec">
                                <h3 class="mb-2" style="font-size: 26px; font-weight: 500;">CHANGE CONTROL <span style="font-size: 24px;">🔄</span></h3>
                                <p class="text-muted mb-0" style="font-size: 16px;">Create and track change requests, status approvals, and task tasks.</p>
                            </div>
